...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop WINCASHCOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "WINCASHCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WINCASHCOIN features */
        {"wincashcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"wincashcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"wincashcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"wincashcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"wincashcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"wincashcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"wincashcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"wincashcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"wincashcoin", "startmasternode", &startmasternode, true, true, false},
        {"wincashcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"wincashcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"wincashcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"wincashcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"wincashcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"wincashcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"wincashcoin", "preparebudget", &preparebudget, true, true, false},
        {"wincashcoin", "submitbudget", &submitbudget, true, true, false},
        {"wincashcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"wincashcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"wincashcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"wincashcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"wincashcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"wincashcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"wincashcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wincashcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"wincashcoin", "mnsync", &mnsync, true, true, false},
        {"wincashcoin", "spork", &spork, true, true, false},
        {"wincashcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
//        {"zerocoin", "getzwccseed", &getzwccseed, false, false, true},
//        {"zerocoin", "setzwccseed", &setzwccseed, false, false, true},
//        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
//        {"zerocoin", "searchdzwcc", &searchdzwcc, false, false, true},
//        {"zerocoin", "dzwccstate", &dzwccstate, false, false, true},
...
{
    return "> wincashcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39907/\n";
}
