...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total wincashcoin balance of the wallet (excluding zerocoins)\n"
...
//            "  \"zWCCsupply\" :\n"
//            "  {\n"
//            "     \"1\" : n,            (numeric) supply of 1 zWCC denomination\n"
//            "     \"5\" : n,            (numeric) supply of 5 zWCC denomination\n"
//            "     \"10\" : n,           (numeric) supply of 10 zWCC denomination\n"
//            "     \"50\" : n,           (numeric) supply of 50 zWCC denomination\n"
//            "     \"100\" : n,          (numeric) supply of 100 zWCC denomination\n"
//            "     \"500\" : n,          (numeric) supply of 500 zWCC denomination\n"
//            "     \"1000\" : n,         (numeric) supply of 1000 zWCC denomination\n"
//            "     \"5000\" : n,         (numeric) supply of 5000 zWCC denomination\n"
//            "     \"total\" : n,        (numeric) The total supply of all zWCC denominations\n"
//            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in wincashcoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in wincashcoin/kb\n"
...
//        obj.push_back(Pair("zerocoinbalance", ValueFromAmount(pwalletMain->GetZerocoinBalance(true))));
    ...
    UniValue zwccObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zwccObj.push_back(Pair(std::to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zwccObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
//    obj.push_back(Pair("zWCCsupply", zwccObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"wincashcoinaddress\"\n"
            "\nReturn information about the given wincashcoin address.\n"

            "\nArguments:\n"
            "1. \"wincashcoinaddress\"     (string, required) The wincashcoin address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"wincashcoinaddress\", (string) The wincashcoin address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: WINCASHCOIN address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw std::runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are wincashcoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) wincashcoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"wincashcoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"wincashcoinaddress\"  (string, required) The wincashcoin address to use for the signature.\n"
