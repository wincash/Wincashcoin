...
#ifndef WINCASHCOIN_ZWCCTRACKER_H
#define WINCASHCOIN_ZWCCTRACKER_H
...
public:
    CzWCCTracker(std::string strWalletFile);
    ~CzWCCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzWCCWallet* zWCCWallet = NULL);
...
#endif //WINCASHCOIN_ZWCCTRACKER_H
