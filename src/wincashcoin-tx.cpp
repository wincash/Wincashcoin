...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WincashCoin Core wincashcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  wincashcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wincashcoin transaction") + "\n" +
                               "  wincashcoin-tx [options] -create [commands]   " + _("Create hex-encoded wincashcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wincashcoin transaction
