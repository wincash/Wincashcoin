                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzWCCPathCustom = GetArg("-zwccbackuppath", "");
    ...
    if(!strzWCCPathCustom.empty()) {
        ui->wallet_customzwccbackuppath->setText(QString::fromStdString(strzWCCPathCustom));
        ui->wallet_customzwccbackuppath_label->setVisible(true);
        ui->wallet_customzwccbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzWCCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the WINCASHCOIN RPC console.") + "<br>" +
