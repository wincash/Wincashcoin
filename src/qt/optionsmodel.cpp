...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::WCC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeWincashCoinAmount"))
        SoftSetArg("-anonymizewincashcoinamount", settings.value("nAnonymizeWincashCoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in wincashcoin.cpp during shotdown to also remove the window positions
