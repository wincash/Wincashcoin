...
public:
    ...
    void setZWccControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzWCC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzWCC_clicked();
    void on_pushButtonZWccControl_clicked();
