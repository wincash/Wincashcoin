...
/** Utility functions used by the WINCASHCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render WINCASHCOIN addresses in monospace font
...
// Parse "wincashcoin:" URI into recipient object, return true on successful parsing
