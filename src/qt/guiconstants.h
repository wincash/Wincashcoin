...
/* WincashCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "WINCASHCOIN"
#define QAPP_ORG_DOMAIN "wincashcoin.io"
#define QAPP_APP_NAME_DEFAULT "WINCASHCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "WINCASHCOIN-Qt-testnet"
