...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("WINCASHCOIN Core"),
     ...
     * override -datadir in the wincashcoin.conf file in the default data directory
     * (to be consistent with wincashcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
