...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/wincashcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/wincashcoin-cli.cpp \
           src/wincashcoin-tx.cpp \
           src/wincashcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/wincashcoin.qrc src/qt/wincashcoin_locale.qrc

TRANSLATIONS += src/qt/locale/wincashcoin_bg.ts \
                src/qt/locale/wincashcoin_de.ts \
                src/qt/locale/wincashcoin_en.ts \
                src/qt/locale/wincashcoin_es.ts \
                src/qt/locale/wincashcoin_fi.ts \
                src/qt/locale/wincashcoin_fr.ts \
                src/qt/locale/wincashcoin_it.ts \
                src/qt/locale/wincashcoin_ja.ts \
                src/qt/locale/wincashcoin_pl.ts \
                src/qt/locale/wincashcoin_pt.ts \
                src/qt/locale/wincashcoin_ru.ts \
                src/qt/locale/wincashcoin_sk.ts \
                src/qt/locale/wincashcoin_sv.ts \
                src/qt/locale/wincashcoin_vi.ts \
                src/qt/locale/wincashcoin_zh_CN.ts \
                src/qt/locale/wincashcoin_zh_TW.ts
