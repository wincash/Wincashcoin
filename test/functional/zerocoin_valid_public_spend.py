...
from fake_stake.base_test import WINCASHCOIN_FakeStakeTest

class zWCCValidCoinSpendTest(WINCASHCOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zWCCs..." % DENOM_TO_USE)
