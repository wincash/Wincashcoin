...
This document provides guidelines for internationalization of the WINCASHCOIN Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to WINCASHCOIN network</numerusform>
            <numerusform>%n active connections to WINCASHCOIN network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wincashcoin_en.ts` remains unchanged.
