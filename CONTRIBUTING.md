Contributing to WINCASHCOIN Core
============================

The WINCASHCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/wincashcoin-project/wincashcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the WINCASHCOIN Core project, and is not to be
confused with overall WINCASHCOIN Network Protocol consensus changes.

Whether a pull request is merged into WINCASHCOIN Core rests with the project merge
...
Patches that change WINCASHCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the WINCASHCOIN consensus, it must have been
...
The project leader is the release manager for each WINCASHCOIN Core release.
